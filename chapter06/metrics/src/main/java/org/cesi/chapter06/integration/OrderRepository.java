...
public class OrderRepository {
    ...
    //comptage d'un nombre total des commandes
    // @Transactional //solution de contournement pour que l'exportation de la jauge peakOfOrders fonctionne quand JPA est utilisé
    // @ActivateRequestContext //autre solution de contournement //placée sur OrderEndpoint
    public Long countAll(){
        return entityManager.createNamedQuery("Orders.countAll",Long.class).getSingleResult();
    }
