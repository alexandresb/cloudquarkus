package org.cesi.chapter05.boundary;

import org.cesi.chapter05.entity.Customer;
import org.cesi.chapter05.entity.Order;
import org.cesi.chapter05.integration.CustomerException;
import org.cesi.chapter05.integration.CustomerRepository;
import org.cesi.chapter05.integration.OrderRepository;
...
public class OrderEndpoint {
    ...
    public Response update(Order order){
        try{
            ...
            throw new WebApplicationException("Order id="+order.id+" not found",404);
        }
